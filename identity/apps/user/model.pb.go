...
// 	protoc        v3.21.6
// source: modules/identity/apps/user/pb/model.proto
...
func (PROVIDER) Descriptor() protoreflect.EnumDescriptor {
	return file_modules_identity_apps_user_pb_model_proto_enumTypes[0].Descriptor()
}

func (PROVIDER) Type() protoreflect.EnumType {
	return &file_modules_identity_apps_user_pb_model_proto_enumTypes[0]
}
...
func (PROVIDER) EnumDescriptor() ([]byte, []int) {
	return file_modules_identity_apps_user_pb_model_proto_rawDescGZIP(), []int{0}
}
...
func (TYPE) Descriptor() protoreflect.EnumDescriptor {
	return file_modules_identity_apps_user_pb_model_proto_enumTypes[1].Descriptor()
}

func (TYPE) Type() protoreflect.EnumType {
	return &file_modules_identity_apps_user_pb_model_proto_enumTypes[1]
}
...
func (TYPE) EnumDescriptor() ([]byte, []int) {
	return file_modules_identity_apps_user_pb_model_proto_rawDescGZIP(), []int{1}
}
...
func (Gender) Descriptor() protoreflect.EnumDescriptor {
	return file_modules_identity_apps_user_pb_model_proto_enumTypes[2].Descriptor()
}

func (Gender) Type() protoreflect.EnumType {
	return &file_modules_identity_apps_user_pb_model_proto_enumTypes[2]
}
...
func (Gender) EnumDescriptor() ([]byte, []int) {
	return file_modules_identity_apps_user_pb_model_proto_rawDescGZIP(), []int{2}
}
...
func (CREATE_FROM) Descriptor() protoreflect.EnumDescriptor {
	return file_modules_identity_apps_user_pb_model_proto_enumTypes[3].Descriptor()
}

func (CREATE_FROM) Type() protoreflect.EnumType {
	return &file_modules_identity_apps_user_pb_model_proto_enumTypes[3]
}
...
func (CREATE_FROM) EnumDescriptor() ([]byte, []int) {
	return file_modules_identity_apps_user_pb_model_proto_rawDescGZIP(), []int{3}
}
...
func (DESCRIBE_BY) Descriptor() protoreflect.EnumDescriptor {
	return file_modules_identity_apps_user_pb_model_proto_enumTypes[4].Descriptor()
}

func (DESCRIBE_BY) Type() protoreflect.EnumType {
	return &file_modules_identity_apps_user_pb_model_proto_enumTypes[4]
}
...
func (DESCRIBE_BY) EnumDescriptor() ([]byte, []int) {
	return file_modules_identity_apps_user_pb_model_proto_rawDescGZIP(), []int{4}
}
...
func (x *Password) Reset() {
	*x = Password{}
	if protoimpl.UnsafeEnabled {
		mi := &file_modules_identity_apps_user_pb_model_proto_msgTypes[0]
...
func (x *Status) Reset() {
	*x = Status{}
	if protoimpl.UnsafeEnabled {
		mi := &file_modules_identity_apps_user_pb_model_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *User) Reset() {
	*x = User{}
	if protoimpl.UnsafeEnabled {
		mi := &file_modules_identity_apps_user_pb_model_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
type Profile struct {
	...
	Gender Gender `protobuf:"varint,6,opt,name=gender,proto3,enum=infraboard.modules.identity.user.Gender" json:"gender" bson:"gender" validate:"lte=10"`
	// 头像
...
func (x *Profile) Reset() {
	*x = Profile{}
	if protoimpl.UnsafeEnabled {
		mi := &file_modules_identity_apps_user_pb_model_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
type CreateUserRequest struct {
	...
	Provider PROVIDER `protobuf:"varint,1,opt,name=provider,proto3,enum=infraboard.modules.identity.user.PROVIDER" json:"provider" bson:"provider"`
	// 用户类型
	// @gotags: json:"type" bson:"type"
	Type TYPE `protobuf:"varint,2,opt,name=type,proto3,enum=infraboard.modules.identity.user.TYPE" json:"type" bson:"type"`
	// 创建来源
	// @gotags: json:"create_from" bson:"create_from"
	CreateFrom CREATE_FROM `protobuf:"varint,3,opt,name=create_from,json=createFrom,proto3,enum=infraboard.modules.identity.user.CREATE_FROM" json:"create_from" bson:"create_from"`
	// 创建类型
	...
	Feishu *Feishu `protobuf:"bytes,9,opt,name=feishu,proto3" json:"feishu" bson:"feishu"`
	// 用户钉钉相关信息
	// @gotags: json:"dingding" bson:"dingding"
	Dingding *DingDing `protobuf:"bytes,10,opt,name=dingding,proto3" json:"dingding" bson:"dingding"`
	// 用户企业微信相关信息
	// @gotags: json:"wechatwork" bson:"wechatwork"
	Wechatwork *WechatWork `protobuf:"bytes,11,opt,name=wechatwork,proto3" json:"wechatwork" bson:"wechatwork"`
	// Profile信息
	// @gotags bson:"profile" json:"profile"
	Profile *Profile `protobuf:"bytes,12,opt,name=profile,proto3" json:"profile,omitempty"`
	// 用户其他属性
	// @gotags: json:"extras" bson:"extras"
	Extras map[string]string `protobuf:"bytes,15,rep,name=extras,proto3" json:"extras" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"extras"`
}

func (x *CreateUserRequest) Reset() {
	*x = CreateUserRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_modules_identity_apps_user_pb_model_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *CreateUserRequest) GetExtras() map[string]string {
	if x != nil {
		return x.Extras
	}
	return nil
...
func (x *Feishu) Reset() {
	*x = Feishu{}
	if protoimpl.UnsafeEnabled {
		mi := &file_modules_identity_apps_user_pb_model_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Feishu) Descriptor() ([]byte, []int) {
	return file_modules_identity_apps_user_pb_model_proto_rawDescGZIP(), []int{5}
}
...
func (x *FeishuAccessToken) Reset() {
	*x = FeishuAccessToken{}
	if protoimpl.UnsafeEnabled {
		mi := &file_modules_identity_apps_user_pb_model_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FeishuAccessToken) Descriptor() ([]byte, []int) {
	return file_modules_identity_apps_user_pb_model_proto_rawDescGZIP(), []int{6}
}
...
func (x *DingDing) Reset() {
	*x = DingDing{}
	if protoimpl.UnsafeEnabled {
		mi := &file_modules_identity_apps_user_pb_model_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DingDing) Descriptor() ([]byte, []int) {
	return file_modules_identity_apps_user_pb_model_proto_rawDescGZIP(), []int{7}
}
...
func (x *DingDingAccessToken) Reset() {
	*x = DingDingAccessToken{}
	if protoimpl.UnsafeEnabled {
		mi := &file_modules_identity_apps_user_pb_model_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DingDingAccessToken) Descriptor() ([]byte, []int) {
	return file_modules_identity_apps_user_pb_model_proto_rawDescGZIP(), []int{8}
}
...
func (x *WechatWork) Reset() {
	*x = WechatWork{}
	if protoimpl.UnsafeEnabled {
		mi := &file_modules_identity_apps_user_pb_model_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WechatWork) Descriptor() ([]byte, []int) {
	return file_modules_identity_apps_user_pb_model_proto_rawDescGZIP(), []int{9}
}
...
func (x *UserSet) Reset() {
	*x = UserSet{}
	if protoimpl.UnsafeEnabled {
		mi := &file_modules_identity_apps_user_pb_model_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserSet) Descriptor() ([]byte, []int) {
	return file_modules_identity_apps_user_pb_model_proto_rawDescGZIP(), []int{10}
}
...
var File_modules_identity_apps_user_pb_model_proto protoreflect.FileDescriptor

var file_modules_identity_apps_user_pb_model_proto_rawDesc = []byte{
	0x0a, 0x29, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x73, 0x2f, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69,
	0x74, 0x79, 0x2f, 0x61, 0x70, 0x70, 0x73, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x70, 0x62, 0x2f,
	0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x20, 0x69, 0x6e, 0x66,
	0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x73, 0x2e,
	0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x1a, 0x1c, 0x6d,
	0x63, 0x75, 0x62, 0x65, 0x2f, 0x70, 0x62, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x2f, 0x6d, 0x65, 0x74, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x86, 0x02, 0x0a, 0x08,
	...
	0x77, 0x6f, 0x72, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x61,
	...
	0x0a, 0x0a, 0x6e, 0x65, 0x65, 0x64, 0x5f, 0x72, 0x65, 0x73, 0x65, 0x74, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x09, 0x6e, 0x65, 0x65, 0x64, 0x52, 0x65, 0x73, 0x65, 0x74, 0x12, 0x21, 0x0a,
	...
	,
	...
	0x69, 0x6d, 0x65, 0x22, 0xc4, 0x03, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x33, 0x0a, 0x04,
	...
	0x33, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d, 0x6f, 0x64,
	...
	0x75, 0x65, 0x73, 0x74, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x12, 0x46, 0x0a, 0x08, 0x70, 0x61,
	0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x69,
	0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65,
	0x73, 0x2e, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e,
	0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f,
	0x72, 0x64, 0x12, 0x40, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x05, 0x20, 0x01,
	...
	,
	...
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x40, 0x0a, 0x06, 0x67, 0x65, 0x6e, 0x64, 0x65, 0x72,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x28, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f,
	0x61, 0x72, 0x64, 0x2e, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x73, 0x2e, 0x69, 0x64, 0x65, 0x6e,
	0x74, 0x69, 0x74, 0x79, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x47, 0x65, 0x6e, 0x64, 0x65, 0x72,
	...
	,
	...
	0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3f, 0x2e,
	...
	,
	...
	0x69, 0x6c, 0x65, 0x12, 0x57, 0x0a, 0x06, 0x65, 0x78, 0x74, 0x72, 0x61, 0x73, 0x18, 0x0f, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x3f, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62, 0x6f, 0x61, 0x72, 0x64,
	0x2e, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x73, 0x2e, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74,
	0x79, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65,
	0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x45, 0x78, 0x74, 0x72, 0x61, 0x73, 0x45,
	...
	,
	...
	0x45, 0x52, 0x10, 0x0f, 0x2a, 0x2b, 0x0a, 0x06, 0x47, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x12, 0x0b,
	...
	,
}

var (
	file_modules_identity_apps_user_pb_model_proto_rawDescOnce sync.Once
	file_modules_identity_apps_user_pb_model_proto_rawDescData = file_modules_identity_apps_user_pb_model_proto_rawDesc
)

func file_modules_identity_apps_user_pb_model_proto_rawDescGZIP() []byte {
	file_modules_identity_apps_user_pb_model_proto_rawDescOnce.Do(func() {
		file_modules_identity_apps_user_pb_model_proto_rawDescData = protoimpl.X.CompressGZIP(file_modules_identity_apps_user_pb_model_proto_rawDescData)
	})
	return file_modules_identity_apps_user_pb_model_proto_rawDescData
}

var file_modules_identity_apps_user_pb_model_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_modules_identity_apps_user_pb_model_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_modules_identity_apps_user_pb_model_proto_goTypes = []interface{}{
	(PROVIDER)(0),               // 0: infraboard.modules.identity.user.PROVIDER
	(TYPE)(0),                   // 1: infraboard.modules.identity.user.TYPE
	(Gender)(0),                 // 2: infraboard.modules.identity.user.Gender
	(CREATE_FROM)(0),            // 3: infraboard.modules.identity.user.CREATE_FROM
	(DESCRIBE_BY)(0),            // 4: infraboard.modules.identity.user.DESCRIBE_BY
	(*Password)(nil),            // 5: infraboard.modules.identity.user.Password
	(*Status)(nil),              // 6: infraboard.modules.identity.user.Status
	(*User)(nil),                // 7: infraboard.modules.identity.user.User
	(*Profile)(nil),             // 8: infraboard.modules.identity.user.Profile
	(*CreateUserRequest)(nil),   // 9: infraboard.modules.identity.user.CreateUserRequest
	(*Feishu)(nil),              // 10: infraboard.modules.identity.user.Feishu
	(*FeishuAccessToken)(nil),   // 11: infraboard.modules.identity.user.FeishuAccessToken
	(*DingDing)(nil),            // 12: infraboard.modules.identity.user.DingDing
	(*DingDingAccessToken)(nil), // 13: infraboard.modules.identity.user.DingDingAccessToken
	(*WechatWork)(nil),          // 14: infraboard.modules.identity.user.WechatWork
	(*UserSet)(nil),             // 15: infraboard.modules.identity.user.UserSet
	nil,                         // 16: infraboard.modules.identity.user.CreateUserRequest.LabelsEntry
	nil,                         // 17: infraboard.modules.identity.user.CreateUserRequest.ExtrasEntry
	(*resource.Meta)(nil),       // 18: infraboard.mcube.resource.Meta
}
var file_modules_identity_apps_user_pb_model_proto_depIdxs = []int32{
	18, // 0: infraboard.modules.identity.user.User.meta:type_name -> infraboard.mcube.resource.Meta
	9,  // 1: infraboard.modules.identity.user.User.spec:type_name -> infraboard.modules.identity.user.CreateUserRequest
	5,  // 2: infraboard.modules.identity.user.User.password:type_name -> infraboard.modules.identity.user.Password
	6,  // 3: infraboard.modules.identity.user.User.status:type_name -> infraboard.modules.identity.user.Status
	11, // 4: infraboard.modules.identity.user.User.feishu_token:type_name -> infraboard.modules.identity.user.FeishuAccessToken
	13, // 5: infraboard.modules.identity.user.User.dingding_token:type_name -> infraboard.modules.identity.user.DingDingAccessToken
	2,  // 6: infraboard.modules.identity.user.Profile.gender:type_name -> infraboard.modules.identity.user.Gender
	0,  // 7: infraboard.modules.identity.user.CreateUserRequest.provider:type_name -> infraboard.modules.identity.user.PROVIDER
	1,  // 8: infraboard.modules.identity.user.CreateUserRequest.type:type_name -> infraboard.modules.identity.user.TYPE
	3,  // 9: infraboard.modules.identity.user.CreateUserRequest.create_from:type_name -> infraboard.modules.identity.user.CREATE_FROM
	16, // 10: infraboard.modules.identity.user.CreateUserRequest.labels:type_name -> infraboard.modules.identity.user.CreateUserRequest.LabelsEntry
	10, // 11: infraboard.modules.identity.user.CreateUserRequest.feishu:type_name -> infraboard.modules.identity.user.Feishu
	12, // 12: infraboard.modules.identity.user.CreateUserRequest.dingding:type_name -> infraboard.modules.identity.user.DingDing
	14, // 13: infraboard.modules.identity.user.CreateUserRequest.wechatwork:type_name -> infraboard.modules.identity.user.WechatWork
	8,  // 14: infraboard.modules.identity.user.CreateUserRequest.profile:type_name -> infraboard.modules.identity.user.Profile
	17, // 15: infraboard.modules.identity.user.CreateUserRequest.extras:type_name -> infraboard.modules.identity.user.CreateUserRequest.ExtrasEntry
	7,  // 16: infraboard.modules.identity.user.UserSet.items:type_name -> infraboard.modules.identity.user.User
...
func init() { file_modules_identity_apps_user_pb_model_proto_init() }
func file_modules_identity_apps_user_pb_model_proto_init() {
	if File_modules_identity_apps_user_pb_model_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_modules_identity_apps_user_pb_model_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_modules_identity_apps_user_pb_model_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Status); i {
			case 0:
				return &v.state
			case 1:
		...
		file_modules_identity_apps_user_pb_model_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
		...
		file_modules_identity_apps_user_pb_model_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_modules_identity_apps_user_pb_model_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_modules_identity_apps_user_pb_model_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Feishu); i {
			case 0:
				return &v.state
			case 1:
		...
		file_modules_identity_apps_user_pb_model_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_modules_identity_apps_user_pb_model_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_modules_identity_apps_user_pb_model_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_modules_identity_apps_user_pb_model_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_modules_identity_apps_user_pb_model_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_modules_identity_apps_user_pb_model_proto_rawDesc,
			NumEnums:      5,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_modules_identity_apps_user_pb_model_proto_goTypes,
		DependencyIndexes: file_modules_identity_apps_user_pb_model_proto_depIdxs,
		EnumInfos:         file_modules_identity_apps_user_pb_model_proto_enumTypes,
		MessageInfos:      file_modules_identity_apps_user_pb_model_proto_msgTypes,
	}.Build()
	File_modules_identity_apps_user_pb_model_proto = out.File
	file_modules_identity_apps_user_pb_model_proto_rawDesc = nil
	file_modules_identity_apps_user_pb_model_proto_goTypes = nil
	file_modules_identity_apps_user_pb_model_proto_depIdxs = nil
}
