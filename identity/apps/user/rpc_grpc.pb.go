...
const (
	RPC_QueryUser_FullMethodName    = "/infraboard.modules.identity.user.RPC/QueryUser"
	RPC_DescribeUser_FullMethodName = "/infraboard.modules.identity.user.RPC/DescribeUser"
)
...
var RPC_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "infraboard.modules.identity.user.RPC",
	...
	Metadata: "modules/identity/apps/user/pb/rpc.proto",
}
